...
## Next feature: digital cave exploration

The owner's intended direction for spelunk is digital exploration inside caves. Begin with one real, suitably licensed cave survey, then extend to caves with usable internal measurements or models; not every catalogue entry will have one. Prefer a simple rotatable passage/shaft outline to detailed textures or photorealistic geometry. Our current location/depth/length fields cannot reconstruct a cave's shape.
